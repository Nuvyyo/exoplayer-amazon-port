...
public abstract class DownloadAction {
  ...
  public static synchronized Deserializer[] getDefaultDeserializers() {
    ...
    try {
      // LINT.IfChange
      clazz = Class.forName("com.google.android.exoplayer2.amazon.source.dash.offline.DashDownloadAction");
    ...
    try {
      // LINT.IfChange
      clazz = Class.forName("com.google.android.exoplayer2.amazon.source.hls.offline.HlsDownloadAction");
    ...
    try {
      ...
      clazz =
          Class.forName(
              "com.google.android.exoplayer2.amazon.source.smoothstreaming.offline.SsDownloadAction");
