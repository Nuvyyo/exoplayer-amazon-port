...
import com.google.android.exoplayer2.amazon.audio.AudioProcessor;
import com.google.android.exoplayer2.amazon.audio.AudioRendererEventListener;
import com.google.android.exoplayer2.amazon.audio.MediaCodecAudioRenderer;
...
import com.google.android.exoplayer2.amazon.mediacodec.MediaCodecSelector;
import com.google.android.exoplayer2.amazon.metadata.MetadataOutput;
import com.google.android.exoplayer2.amazon.metadata.MetadataRenderer;
import com.google.android.exoplayer2.amazon.text.TextOutput;
import com.google.android.exoplayer2.amazon.text.TextRenderer;
...
import com.google.android.exoplayer2.amazon.video.MediaCodecVideoRenderer;
import com.google.android.exoplayer2.amazon.video.VideoRendererEventListener;
import com.google.android.exoplayer2.amazon.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer2.amazon.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              boolean.class,
              long.class,
              android.os.Handler.class,
              com.google.android.exoplayer2.amazon.video.VideoRendererEventListener.class,
              int.class);
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer2.amazon.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer2.amazon.audio.AudioRendererEventListener.class,
              com.google.android.exoplayer2.amazon.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.google.android.exoplayer2.amazon.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer2.amazon.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.google.android.exoplayer2.amazon.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.google.android.exoplayer2.amazon.audio.AudioRendererEventListener.class,
