...
public final class ExoPlayerLibraryInfo {
  ...
  public static final String VERSION_SLASHY = "AmznExoPlayerLib/2.9.0";
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.exoplayer2.amazon.util.Assertions}
   * checks enabled.
   */
  ...
  /**
   * Whether the library was compiled with {@link com.google.android.exoplayer2.amazon.util.TraceUtil}
   * trace enabled.
   */
