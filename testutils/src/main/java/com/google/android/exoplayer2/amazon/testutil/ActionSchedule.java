...
import com.google.android.exoplayer2.amazon.PlayerMessage;
import com.google.android.exoplayer2.amazon.PlayerMessage.Target;
...
import com.google.android.exoplayer2.amazon.testutil.Action.ClearVideoSurface;
import com.google.android.exoplayer2.amazon.testutil.Action.ExecuteRunnable;
import com.google.android.exoplayer2.amazon.testutil.Action.PlayUntilPosition;
import com.google.android.exoplayer2.amazon.testutil.Action.PrepareSource;
import com.google.android.exoplayer2.amazon.testutil.Action.Seek;
import com.google.android.exoplayer2.amazon.testutil.Action.SendMessages;
import com.google.android.exoplayer2.amazon.testutil.Action.SetPlayWhenReady;
import com.google.android.exoplayer2.amazon.testutil.Action.SetPlaybackParameters;
import com.google.android.exoplayer2.amazon.testutil.Action.SetRendererDisabled;
import com.google.android.exoplayer2.amazon.testutil.Action.SetRepeatMode;
import com.google.android.exoplayer2.amazon.testutil.Action.SetShuffleModeEnabled;
import com.google.android.exoplayer2.amazon.testutil.Action.SetVideoSurface;
import com.google.android.exoplayer2.amazon.testutil.Action.Stop;
import com.google.android.exoplayer2.amazon.testutil.Action.ThrowPlaybackException;
import com.google.android.exoplayer2.amazon.testutil.Action.WaitForPlaybackState;
import com.google.android.exoplayer2.amazon.testutil.Action.WaitForPositionDiscontinuity;
import com.google.android.exoplayer2.amazon.testutil.Action.WaitForSeekProcessed;
import com.google.android.exoplayer2.amazon.testutil.Action.WaitForTimelineChanged;
...
import com.google.android.exoplayer2.amazon.util.HandlerWrapper;
...
public final class ActionSchedule {
  ...
  public static final class Builder {
    ...
    /**
     * Schedules a new source preparation action to be executed.
     * @see com.google.android.exoplayer2.amazon.ExoPlayer#prepare(MediaSource, boolean, boolean).
     *
     * @return The builder, for convenience.
     */
